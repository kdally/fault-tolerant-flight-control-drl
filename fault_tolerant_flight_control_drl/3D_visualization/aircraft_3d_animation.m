...
text_color  = [1, 0, 1];
font_name   = 'Consolas';
hdle_text_t                 = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 1.5, 0.59 * AC_DIMENSION * 1.5 , 't=  0 sec', 'Color',text_color, 'FontSize',FontSize, 'FontName', font_name);
hdle_text_valtitude         = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 1.5, 0.56 * AC_DIMENSION * 1.5, '', 'Color',text_color, 'FontSize', FontSize, 'FontName', font_name);
...
%     
    ...
    set(hdle_text_valtitude, 'String',strcat('h=',num2str(altitude_ft(i), '%4.0f m')))
